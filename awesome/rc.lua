...
--run_once({ "google-chrome-stable", "terminator", "vncviewer", "/opt/PixInsight/bin/PixInsight.sh" , "code" }) -- comma-separated entries

run_once({ "picom" ,"dropbox", "flameshot", "unclutter -root" }) -- comma-separated entries
